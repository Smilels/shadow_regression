'''
test more data augmentation version
'''
...
from model_spatialsoftmax import JointRegression
...
parser.add_argument('--test-batch-size', type=int, default=1028, metavar='N',
...
class VisdomLinePlotter(object):
    ...
    def image(self,map_feature):
            self.viz.image(map_feature,
                env='map1', opts=dict(
                title='map1'))
