...
class Map_Loader(object):
    def __init__(self, base_path= "./data/"):
        ...
        self.framelist = [lines[int(ln)].split(' ')[0].replace("\t", "") for ln in ra ]
        label_source = [lines[int(ln)].split('\t')[1:] for ln in ra]
...
if __name__ == '__main__':
    ...
    #csvSum = open(base_path + "human_robot_mapdata_3k4k.csv", "w")
